package io.graphile.config;

import io.graphile.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("io.graphile.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("io.graphile.repository.search")
